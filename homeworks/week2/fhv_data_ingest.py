...
OUTPUT_FILE_TEMPLATE = path_to_local_home + '/fhv_tripdata_{{ execution_date.strftime(\'%Y-%m\') }}.csv'
...
with DAG(
    ...
    download_dataset_task >> format_to_parquet_task >> local_to_gcs_task >> delete_temp_file
